...
const comparePassword = (// password inputed is raw, function to re-encrypt & compare password when user tries to log in
password, hashPassword) => __awaiter(void 0, void 0, void 0, function* () {
